...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-y7k-xek.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-y7k-xek.containers.anotherwebservice.com/
...
```
git clone git@github.com:YOUgggg123/container-y7k-xek.git
cd container-y7k-xek
```
...
```
docker attach container-y7k-xek
```
